...
public class InputLeftResponse extends PiResponse {

	private static final String TAG = "pimote:InputLeftResponse";
	
	public InputLeftResponse(String json, boolean status) {
		super(json, status);
		Log.d(TAG, "InputLeftResponse()");
	}
