...
public class InputUpResponse extends PiResponse {

	private static final String TAG = "pimote:InputUpResponse";
	
	public InputUpResponse(String json, boolean status) {
		super(json, status);
		Log.d(TAG, "InputUpResponse()");
	}
